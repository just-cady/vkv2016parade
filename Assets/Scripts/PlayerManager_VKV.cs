...
namespace com.kreweofvaporwave.parade
{
    ...
    /// </summary>
    public class PlayerManager_VKV : Photon.PunBehaviour, IPunObservable
    {
        ...
        public void Start()
        {
            CameraWork_VKV _cameraWork = gameObject.GetComponent<CameraWork_VKV>();
        ...
        public void Update()
        {
            ...
            if (photonView.isMine)
            {
                ...
                /*if (this.Health <= 0f)
                {
                    GameManager_VKV.Instance.LeaveRoom();
                }*/
            }
