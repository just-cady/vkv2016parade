...
namespace com.kreweofvaporwave.parade
{
	...
	/// </summary>
	public class GameManager_VKV : Photon.MonoBehaviour {

		#region Public Variables

		static public GameManager_VKV Instance;
		...
		void Start()
		{
			...
			if (playerPrefab == null) { // #Tip Never assume public properties of Components are filled up properly, always check and inform the developer of it.
				...
				if (PlayerManager_VKV.LocalPlayerInstance==null)
				{
					Debug.Log("We are Instantiating LocalPlayer from "+SceneManagerHelper.ActiveSceneName);

					// we're in a room. spawn a character for the local player. it gets synced by using PhotonNetwork.Instantiate
					PhotonNetwork.Instantiate(this.playerPrefab.name, new Vector3(-10f,5f,0f), Quaternion.identity, 0);
				}else{
